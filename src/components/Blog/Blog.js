            ...
            <div>
                  ...
                  <div>
                       <h3>Q:3--Differences between Sql and NoSql databases.</h3> 
                        ...
                        1.SQL databases are based on the tables, whereas NoSQL databases are based on the document, graph, and so on.
                        2.SQL databases are better for multi-row transactions while NoSQL is better for JSON.
                        3.SQL databases are vertically scalable, but NoSQL databases are horizontally scalable.
                        4.SQL databases have predefined schemas that use structured query language. On the other hand, NoSQL doesn't use structured data.
                        5.SQL databases are relational and NoSQL are non-relational.
                        6.SQL is not suitable for hierarchical data storage, but NoSQL is suitable for hierarchical data storage.
                        7.SQL can be used for complex queries. NoSQL is not good for complex queries.
                        8.The best SQL databases available at present are MySQL and Oracle. The most popular NoSQL database is MongoDB.
                        </p>
                  </div>
                  <div>
                       ...
                       JWT consist of several parts, which are decoded and used by the client. They have several benefits over cookies, but as I haven't used them, only read about them, it is all I can share.
                        </p>
                  </div>
            </div>
      );
